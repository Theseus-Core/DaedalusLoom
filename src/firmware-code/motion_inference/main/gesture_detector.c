...
void gesture_detector_init(gesture_detector_t *detector, int class_count)
{
    gesture_detector_reset(detector, class_count);
}

void gesture_detector_reset(gesture_detector_t *detector, int class_count)
{
